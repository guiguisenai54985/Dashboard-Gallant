...
dbcon();
$resultado = $conexao->query("SELECT `id`, `codigo`, `nomeJoia`, `fabricacao`, `genero`, `marca`, `garantia`, `preco`, `precoVenda`, `quant`, `fornecedor`, `modelo`, `material`, `tamanho`, `parcela`, `linkImagem` FROM `joia`");
?>
